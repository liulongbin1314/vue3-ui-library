<template>
  ...
  <div class="row-gap">
    ...
    <a-button type="priamry" disabled>主要</a-button>
  ...
  <div class="row-gap">
    ...
    <a-button type="priamry" text>主要</a-button>
  ...
  <div class="row-gap">
    ...
    <a-button type="priamry" border>主要</a-button>
  ...
  <div class="row-gap">
    ...
    <a-button type="priamry" border dashed>主要</a-button>
  ...
  <div class="row-gap">
    <a-button>默认</a-button>
    <a-button type="priamry" size="default">主要</a-button>
  ...
  <div class="row-gap">
    ...
    <a-button type="priamry" size="default" circle icon="icon-customer-filter"></a-button>
  ...
  <div class="row-gap">
    ...
    <a-button type="priamry" size="default" suffix-icon="icon-customer">主要</a-button>
