<template>
  <a-button-group>
    <a-button @click="position = 'left'">Left</a-button>
    <a-button @click="position = 'right'">Right</a-button>
    <a-button @click="position = 'top'">Top</a-button>
  </a-button-group>

  <hr />
  <a-form :model="formData" width="600px" label-width="100px" :label-position="position">
    ...
    <a-form-item label=" ">
      <a-button style="margin-right: 15px" @click="onReset">重置</a-button>
